export const adMetrics = [
  {
    ...
    description: "Berapa rupiah omzet yang masuk untuk setiap 1 rupiah biaya iklan.",
    benchmark: ">= 3x bagus",
    status: "good",
  },
  {
  ...
  },
  {
    name: "CPC",
    full: "Cost Per Click",
    description: "Biaya per klik iklan. Rendah bagus, tapi kualitas klik tetap penting.",
